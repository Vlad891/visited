...
let remainingValueAfterYears = value % (1000 * 60 * 60 * 24 * 365.25);

let month = Math.floor(remainingValueAfterYears / (1000 * 60 * 60 * 24 * 30.4375));
let remainingValueAfterMonths = remainingValueAfterYears % (1000 * 60 * 60 * 24 * 30.4375);

let day = Math.floor(remainingValueAfterMonths / (1000 * 60 * 60 * 24));
